...
async def vector_search(search_query: VectorSearchQuery):
    try:  # Input validation
        ...
        # Apply priority-based scoring and handle relevance scoring
        for result in formatted_results:
            ...
            if "boosted_score" in result:
                ...
                base_score = result.get("boosted_score", 0)
            elif "score" in result:
                # Single field search result
            ...
            # Normalize and set relevance score
...
async def search_by_jd(
    ...
    try:
        ...
        # Apply priority-based scoring for JD search
        for result in formatted_results:
